...
export class NavbarComponent {
   ...
   *  Only when the Stroje a divízie module is on; otherwise Faktúry renders
   *  as a plain link and the app stays in the profistav division. */
  ...
  get showDivisions(): boolean {
    return this.flags.strojeDivisions() || this.auth.isSuperAdmin();
  }
