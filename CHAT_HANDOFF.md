...
>
> **NEXT SESSION FOCUS: Commander API integration.** Read `COMMANDER_PLAN.md` first, then `SECRETS.md`, then ask the seven open questions in `COMMANDER_PLAN.md` §"Open questions to ask the customer FIRST" before writing any code. Env-var slots (`Commander__Username` / `Commander__Password`) and security guard rails are already in place.
>
